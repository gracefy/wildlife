  ...
  return [
    {
      ...
      reproduction:
        "Usually between 3-5 eyes closed kits are born in April, each weighing about 2 ounces.",
      image: "/images/mammals/raccoon.jpg",
      endangered: false,
    ...
    <p>Raccoons have a wide range of vocalizations including trills and screams, which they use to settle disputes rather than physical aggression. Raccoons’ intelligence prompts them to avoid confrontations with pets or other animals so they don’t risk injury.</p>`,
      ...
      species: [],
      locations: [
        locMap["Rattlesnake Point Conservation Area"],
        locMap["Toronto Zoo"],
        locMap["Ripley's Aquarium of Canada"],
      ],
    },
    {
      type: typeMap["Mammal"],
      ...
      reproduction:
        "Usually 3-5 naked, eyes closed young are born in the spring and again to a lesser extent in late summer. Young remain with the mother for about 3.5 months.",
      image: "/images/mammals/squirrel.jpg",
      endangered: false,
    ...
    Attics provide a short-term safe haven until babies are mobile and active, at about 8 weeks.</p>`,
      ...
      locations: [
        locMap["Rattlesnake Point Conservation Area"],
        locMap["Gatineau Park"],
        locMap["Royal Botanical Gardens"],
      ],
    },
    {
      type: typeMap["Mammal"],
      ...
      species: [],
      locations: [
        locMap["Bruce Peninsula National Park"],
        locMap["Pukaskwa National Park"],
        locMap["Point Pelee National Park"],
        locMap["Royal Botanical Gardens"],
      ],
    },
    {
      ...
      reproduction:
        "Striped Skunks in Ontario are born in May and early June, and average about 6-7 to a litter, can be 16! Their stripes can be full body length or a horseshoe shape. They also have a nose stripe which varies from ‘toothpicks’ to a ‘U’. Their home is a dark den underground or in under a shed, or porch.",
      image: "/images/mammals/skunk.jpg",
      endangered: false,
      ...
      special:
        "<h5>Skunk Spray on the dog or you</h5><ul><li>¼ C Baking Soda</li><li>1 teaspoon dishwashing detergent</li><li>1quart Hydrogen Peroxide</li><li>The detergent breaks down the oil in the spray and the peroxide brings it to the surface and the baking soda neutralizes the Thiols [odor].</li></ul>",
      species: [],
      locations: [
        locMap["Toronto Zoo"],
        locMap["Algonquin Provincial Park"],
        locMap["Pukaskwa National Park"],
      ],
    },
    {
      ...
      reproduction:
        "Usually 4-5 naked, eyes closed young are born in May. The young develop quickly and will be on their own within 3 months.",
      image: "/images/mammals/groundhog.jpg",
      endangered: false,
      ...
      species: [],
      locations: [
        locMap["Lake Superior Provincial Park"],
        locMap["Pukaskwa National Park"],
        locMap["Toronto Zoo"],
        locMap["Rattlesnake Point Conservation Area"],
      ],
    },
    {
      ...
      reproduction:
        "Rabbits usually have 3-4 litters a year. Although litter size can vary, the average is size is about 4-7. Young are born helpless, naked and with their eyes closed.",
      image: "/images/mammals/rabbit.jpg",
      endangered: false,
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction:
        "Birth Month: January. Litter Size: Typically 3 in Ontario. First litters often 1 or 2. Birth Weight: 1/2 pound. Weight at 1 Year: 15 pounds to more than 100 pounds, depending on food supply. Parental Care: 17 months (rarely 29 months), ending in June when mothers become ready to mate again.",
      image: "/images/mammals/blackbear.jpg",
      endangered: false,
    ...
    },
    {
      ...
      reproduction:
        "Usually a litter of about 6 pups are born in the early spring and both parents provide care for the young.",
      image: "/images/mammals/coyote.jpg",
      endangered: false,
    ...
    },
    {
      ...
      reproduction:
        "Pups are born in the spring in an underground den and are fully furred with their eyes closed. Litter size is usually between 4-7.",
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/mammals/bobcat.jpg",
      endangered: false,
      ...
      species: [],
      locations: [
        locMap["Pinery Provincial Park"],
        locMap["Killarney Provincial Park"],
        locMap["Pukaskwa National Park"],
        locMap["Rattlesnake Point Conservation Area"],
      ],
    },
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/mammals/EasternCougar.jpg",
      endangered: false,
    ...
    },
    {
      ...
      reproduction:
        "The average Ontario litter contains five pups. The helpless new-borns are blind and have a woolly coat of greyish-brown or sooty grey. Their eyes open within the first 10 to 12 days, and the adult pelt pattern begins to emerge by the end of the first month. Gray wolves usually live in packs of up to two dozen individuals; packs numbering 6 to 10 are most common.",
      image: "/images/mammals/TimberWolf.jpg",
      endangered: false,
      ...
      species: [],
      locations: [
        locMap["Bon Echo Provincial Park"],
        locMap["Pukaskwa National Park"],
        locMap["Rattlesnake Point Conservation Area"],
      ],
    },
    {
      ...
      reproduction:
        "Happens in February and pups are born in late April/ early May. The main breeding pair in the pack will give birth to 4-6 pups. Pups are nursed in the den for 6-8 weeks, and the whole pack will help feed and raise the pups.",
      image: "/images/mammals/EasternWolf.jpg",
      endangered: false,
    ...
    },
    {
      ...
      reproduction:
        "Usually 2-4 kits are born in the spring or early summer. When the kits are born they are well furred with their eyes open. Young can take to the water soon after birth and are skilled swimmers within a week or two. The kits remain with their parents for the first two years of their lives.",
      image: "/images/mammals/beaver.jpg",
      endangered: false,
    ...
    },
    {
      ...
      reproduction:
        "Sexual maturity is reached at 4-6 years of age. Nests are huge, constructed with sticks usually near the top of a tree and close to water.1-3 eggs are laid and approximately half will survive the first year.",
      image: "/images/birds/BaldEagle.jpg",
      endangered: false,
      ...
      special:
        "<h5>Eagles of Ontario</h5><p>Two types of Eagles in Ontario. They are the Bald Eagle and Golden Eagle. Eagles are iconic ‘king of the skies’ due to their size and power. Once on Ontario's endangered species list have made a comeback in recent years. Eagles live to 25-40 years. Eagles also mate for life.</p>",
      species: [],
      locations: [
        locMap["Point Pelee National Park"],
        locMap["Lake Superior Provincial Park"],
    ...
    },
    {
      ...
      image: "/images/birds/GoldenEagle.jpg",
      endangered: false,
      ...
      species: [
        {
          ...
          image: "/images/birds/hawks/CoopersHawk.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/hawks/Broad-wingedHawk.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/hawks/NorthernGoshawk.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/hawks/NorthernHarrier.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/hawks/Red-tailedHawk.jpg",
          endangered: false,
        },
      ],
      locations: [
      ...
      species: [
        {
          ...
          image: "/images/birds/owls/BarredOwl.jpg",
          endangered: false,
        },
        {
          name: "Barn Owl",
          ...
          image: "/images/birds/owls/BarnOwl.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/owls/EasternSceechOwl.jpg",
          endangered: false,
        },
        {
          name: "Great Gray Owl",
          ...
          image: "/images/birds/owls/GreatGrayOwl.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/owls/GreatHornedOwl.jpg",
          endangered: false,
        },
        {
          name: "Long-eared Owl",
          ...
          image: "/images/birds/owls/Long-earedOwl.jpg",
          endangered: false,
        },
      ],
      locations: [
    ...
    },
    {
      ...
      reproduction:
        "Female Eastern wild turkeys lay on average 10 to 12 eggs per brood. Wild turkey hatchlings are born fully developed and grow very rapidly. Within the first week, chicks can perform species specific behaviours , and by 14 weeks they’ve developed their distinctive male and female plumage.",
      ...
      species: [
        {
          ...
          image: "/images/birds/woodpeckers/Three-toedWoodpecker.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/woodpeckers/Black-backedwoodpecker.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/woodpeckers/DownyWoodpecker.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/woodpeckers/HairyWoodpecker.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/woodpeckers/NorthernFlicker.jpg",
          endangered: false,
        },
        {
          ...
          image: "/images/birds/woodpeckers/PileattedWoodpecker.jpg",
          endangered: false,
        },
      ],
      locations: [
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/birds/SongBirds.jpg",
      endangered: false,
      ...
      species: [
        {
          name: "American Robin",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/AmericanRobin.jpg",
          endangered: false,
        },
        {
          name: "Blue Jay",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/BlueJay.jpg",
          endangered: false,
        },
        {
          name: "Finch-American Goldfinch",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/AmericanGoldfinch.jpg",
          endangered: false,
        },
        {
          name: "Crows-Common Grackel",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/CommonGrackel.jpg",
          endangered: false,
        },
        {
          name: "Cardinals",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/Cardinals.jpg",
          endangered: false,
        },
        {
          name: "Wren-Carolina Wren",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/CarolinaWren.jpg",
          endangered: false,
        },
        {
          name: "Swallow-Tree Swallow",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/TreeSwallow.jpg",
          endangered: false,
        },
        {
          name: "Starling (European)",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/StalingEuropean.jpg",
          endangered: false,
        },
        {
          name: "Yellow Warbler",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/YellowWarbler.jpg",
          endangered: false,
        },
        {
          name: "White-brested Nuthatch",
          desc: "<p>N/A</p>",
          image: "/images/birds/songBirds/White-brestedNuthatch.jpg",
          endangered: false,
        },
      ],
      locations: [
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/birds/WaterBirds.jpg",
      endangered: false,
      ...
      species: [
        {
          ...
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/CommonGoldeneye.jpg",
          endangered: false,
        },
        {
          name: "Ducks-Wood Duck",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/WoodDuck.jpg",
          endangered: false,
        },
        {
          name: "Ducks-Long Tail Duck",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/LongTailDuck.jpg",
          endangered: false,
        },
        {
          name: "Ducks-Mallard",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/MallardDuck.jpg",
          endangered: false,
        },
        {
          name: "Geese-Canada Goose",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/CanadaGoose.jpg",
          endangered: false,
        },
        {
          name: "Swans-Mute Swan",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/MuteSwan.jpg",
          endangered: false,
        },
        {
          name: "Gulls-Herring Gull",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/HerringGull.jpg",
          endangered: false,
        },
        {
          name: "Loons-Common Loon",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/CommonLoon.jpg",
          endangered: false,
        },
        {
          name: "Crains & Herons-American Bittern",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/AmericanBittern.jpg",
          endangered: false,
        },
        {
          name: "Crains & Herons-Green Heron",
          desc: "<p>N/A</p>",
          image: "/images/birds/waterBirds/GreenHeron.jpg",
          endangered: false,
        },
      ],
      locations: [
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle01.jpg",
      endangered: false,
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle02.jpg",
      endangered: false,
      desc: "<p>Ontario is home to eight different species of turtles, with the highest number of turtle species in Canada.  Seven of these species are currently at risk due to habitat loss, hunting, and poaching. Turtles can be found in a variety of habitats such as lakes, ponds, rivers, marshes, and bogs. Some species are very particular about where they live. Map turtles, prefer larger rivers or lakes and may be spotted along the Trent-Severn Waterway. Painted turtles, can be found in a wider variety of habitats.</p><p>During nesting season, which runs from late May to early July, you’ll also spot them crossing roads and in sandy or gravel areas. For more information on turtles in Ontario contact: www.ontarioturtle.ca</p>",
      special: "",
      species: [],
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle03.jpg",
      endangered: false,
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle04.jpg",
      endangered: false,
      desc: "<p>Ontario is home to eight different species of turtles, with the highest number of turtle species in Canada.  Seven of these species are currently at risk due to habitat loss, hunting, and poaching. Turtles can be found in a variety of habitats such as lakes, ponds, rivers, marshes, and bogs. Some species are very particular about where they live. Map turtles, prefer larger rivers or lakes and may be spotted along the Trent-Severn Waterway. Painted turtles, can be found in a wider variety of habitats.</p><p>During nesting season, which runs from late May to early July, you’ll also spot them crossing roads and in sandy or gravel areas. For more information on turtles in Ontario contact: www.ontarioturtle.ca</p>",
      special: "",
      species: [],
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle05.jpg",
      endangered: false,
      desc: "<p>Ontario is home to eight different species of turtles, with the highest number of turtle species in Canada.  Seven of these species are currently at risk due to habitat loss, hunting, and poaching. Turtles can be found in a variety of habitats such as lakes, ponds, rivers, marshes, and bogs. Some species are very particular about where they live. Map turtles, prefer larger rivers or lakes and may be spotted along the Trent-Severn Waterway. Painted turtles, can be found in a wider variety of habitats.</p><p>During nesting season, which runs from late May to early July, you’ll also spot them crossing roads and in sandy or gravel areas. For more information on turtles in Ontario contact: www.ontarioturtle.ca</p>",
      special: "",
      species: [],
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle06.jpg",
      endangered: true,
      desc: "<p>Ontario is home to eight different species of turtles, with the highest number of turtle species in Canada.  Seven of these species are currently at risk due to habitat loss, hunting, and poaching. Turtles can be found in a variety of habitats such as lakes, ponds, rivers, marshes, and bogs. Some species are very particular about where they live. Map turtles, prefer larger rivers or lakes and may be spotted along the Trent-Severn Waterway. Painted turtles, can be found in a wider variety of habitats.</p><p>During nesting season, which runs from late May to early July, you’ll also spot them crossing roads and in sandy or gravel areas. For more information on turtles in Ontario contact: www.ontarioturtle.ca</p>",
      special: "",
      species: [],
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle07.jpg",
      endangered: true,
      desc: "<p>Ontario is home to eight different species of turtles, with the highest number of turtle species in Canada.  Seven of these species are currently at risk due to habitat loss, hunting, and poaching. Turtles can be found in a variety of habitats such as lakes, ponds, rivers, marshes, and bogs. Some species are very particular about where they live. Map turtles, prefer larger rivers or lakes and may be spotted along the Trent-Severn Waterway. Painted turtles, can be found in a wider variety of habitats.</p><p>During nesting season, which runs from late May to early July, you’ll also spot them crossing roads and in sandy or gravel areas. For more information on turtles in Ontario contact: www.ontarioturtle.ca</p>",
      special: "",
      species: [],
    ...
    },
    {
      ...
      diet: "N/A",
      reproduction: "N/A",
      image: "/images/turtle/turtle08.jpg",
      endangered: true,
      desc: "<p>Ontario is home to eight different species of turtles, with the highest number of turtle species in Canada.  Seven of these species are currently at risk due to habitat loss, hunting, and poaching. Turtles can be found in a variety of habitats such as lakes, ponds, rivers, marshes, and bogs. Some species are very particular about where they live. Map turtles, prefer larger rivers or lakes and may be spotted along the Trent-Severn Waterway. Painted turtles, can be found in a wider variety of habitats.</p><p>During nesting season, which runs from late May to early July, you’ll also spot them crossing roads and in sandy or gravel areas. For more information on turtles in Ontario contact: www.ontarioturtle.ca</p>",
      special: "",
      species: [],
...
const seedAnimal = async () => {
  try {
    //drop collection
    // await Animal.collection.dropIndex("species.name_1");
