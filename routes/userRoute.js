...
router.post('/address', [
  ...
  check('fname', 'First Name is at most 20 character and only include characters. No space.').isLength({ max: 20 }).matches(/^[a-zA-Z]+$/),
  check('lname', 'Last Name  is at most 20 character and only include characters. No space.').isLength({ max: 20 }).matches(/^[a-zA-Z]+$/),
